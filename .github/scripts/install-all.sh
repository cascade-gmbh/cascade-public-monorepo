#!/bin/bash
# attention: script assumes to have the repo-root-folder as current directory!

# external components will be either installed 
#   - regularily for the operationg system
#   - or cloned into ../external relative to the repository-root directory 
